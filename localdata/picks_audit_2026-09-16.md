# Racket Factory — Recent picks audit (2026-08-18 to 2026-09-16)
...
- 2026-09-15 B. Cengiz vs G. Maristany selected=G. Maristany winner=? status=pending_no_result reason=no matching result rows found
...
- 2026-09-16 K. Day vs L. Samsonova selected=L. Samsonova winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- `CHALLENGER`: settled=38, wins=17, hit_rate=0.447368, ROI=-0.269429
...
- `Hard`: settled=38, wins=17, hit_rate=0.447368, ROI=-0.269429

## By Bucket

- `SKIPPED_DEAD_EDGE`: settled=22, wins=12, hit_rate=0.545455, ROI=-0.237273
- `WATCHLIST`: settled=13, wins=4, hit_rate=0.307692, ROI=-0.323846
- `WATCHLIST_NO_ODDS`: settled=3, wins=1, hit_rate=0.333333, ROI=None

## By Source

- `Forebet`: settled=38, wins=17, hit_rate=0.447368, ROI=-0.269429
