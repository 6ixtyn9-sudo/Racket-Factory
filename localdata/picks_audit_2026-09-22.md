...
- archived pick rows: 73
- archived pick dates: 3
- ledger pick rows (in window): 73
...
- selected won any set: 44 (0.846154)
- selected won set 1: 36 (0.692308)
- selected won set 2: 37 (0.711538)
- selected won set 3: 9 (0.6)
...
- ledger rows in window (official): 73
...
- 2026-09-22 Kucmova / Laboutkova vs Basiletti / Urgesi selected=Kucmova / Laboutkova winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- `CHALLENGER`: total=14, settled=10, wins=7, hit_rate=0.7, ROI=-0.375, pending=4
- `WTA`: total=59, settled=42, wins=32, hit_rate=0.761905, ROI=-0.12375, pending=17

## By Series

- `Challenger`: total=14, settled=10, wins=7, hit_rate=0.7, ROI=-0.375, pending=4
- `International`: total=59, settled=42, wins=32, hit_rate=0.761905, ROI=-0.12375, pending=17

## By Surface

- `Grass`: total=15, settled=10, wins=7, hit_rate=0.7, ROI=-0.375, pending=5
- `Hard`: total=58, settled=42, wins=32, hit_rate=0.761905, ROI=-0.12375, pending=16

## By Bucket

- `CERTIFIED_CLEAN`: total=5, settled=2, wins=2, hit_rate=1.0, ROI=0.23, pending=3
- `SKIPPED_DEAD_EDGE`: total=10, settled=5, wins=3, hit_rate=0.6, ROI=-0.212, pending=5
- `SKIPPED_VETO`: total=6, settled=1, wins=0, hit_rate=0.0, ROI=-1.0, pending=5
- `WATCHLIST`: total=7, settled=2, wins=1, hit_rate=0.5, ROI=-0.07, pending=5
- `WATCHLIST_NO_ODDS`: total=45, settled=42, wins=33, hit_rate=0.785714, ROI=None, pending=3

## By Source

- `BetClan`: total=73, settled=52, wins=39, hit_rate=0.75, ROI=-0.174, pending=21

## By Regime

- `genesis-2026-09-20`: total=73, settled=52, wins=39, hit_rate=0.75, ROI=-0.174, pending=21
