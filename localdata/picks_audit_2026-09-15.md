...
- priced picks: 34
- ROI: -0.247941
- ROI (real-priced): -0.247941 (n=34)
- ROI (paper-priced): None (n=0)
- pending picks: 11
- void picks: 0
- conflict picks: 0
- total picks: 48
- set diagnostic picks: 37
- selected won any set: 25 (0.675676)
- selected won set 1: 17 (0.459459)
- selected won set 2: 20 (0.540541)
...
- 2026-09-15 B. N. Nakashima vs A. Ilagan selected=A. Ilagan winner=? status=pending_no_result reason=result not final: live/in-progress markers present
- 2026-09-15 A. Mayo vs R. Seggerman selected=A. Mayo winner=? status=pending_no_result reason=result not final: live/in-progress markers present
- 2026-09-15 B. Cengiz vs G. Maristany selected=G. Maristany winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- `CHALLENGER`: settled=37, wins=17, hit_rate=0.459459, ROI=-0.247941
...
- `Hard`: settled=37, wins=17, hit_rate=0.459459, ROI=-0.247941

## By Bucket

- `SKIPPED_DEAD_EDGE`: settled=21, wins=12, hit_rate=0.571429, ROI=-0.200952
- `WATCHLIST`: settled=13, wins=4, hit_rate=0.307692, ROI=-0.323846
- `WATCHLIST_NO_ODDS`: settled=3, wins=1, hit_rate=0.333333, ROI=None

## By Source

- `Forebet`: settled=37, wins=17, hit_rate=0.459459, ROI=-0.247941
