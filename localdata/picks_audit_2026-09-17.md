# Racket Factory — Recent picks audit (2026-09-13 to 2026-09-17)
...
- selected won set 2: 24 (0.55814)
- selected won set 3: 5 (0.3125)
...
- 2026-09-17 F. Jorge vs V. Jimenez Kasintseva selected=F. Jorge winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- `CHALLENGER`: settled=39, wins=18, hit_rate=0.461538, ROI=-0.252778
...
- `Hard`: settled=43, wins=19, hit_rate=0.44186, ROI=-0.292105

## By Bucket

- `SKIPPED_DEAD_EDGE`: settled=23, wins=13, hit_rate=0.565217, ROI=-0.212609
...
- `Forebet`: settled=39, wins=18, hit_rate=0.461538, ROI=-0.252778
