...
- priced picks: 37
- ROI: -0.308108
- ROI (real-priced): -0.308108 (n=37)
- ROI (paper-priced): None (n=0)
- pending picks: 12
- void picks: 0
- conflict picks: 0
- total picks: 54
- set diagnostic picks: 42
- selected won any set: 29 (0.690476)
- selected won set 1: 19 (0.452381)
- selected won set 2: 23 (0.547619)
...
- 2026-09-17 E. Avanesyan vs A. Charaeva selected=A. Charaeva winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- `Hard`: settled=42, wins=18, hit_rate=0.428571, ROI=-0.308108
