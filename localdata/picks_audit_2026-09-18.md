...
- 2026-09-14 F. Diaz Acosta vs M. Alcala Gurri selected=F. Diaz Acosta winner=? status=pending_no_result reason=no matching result rows found
...
- 2026-09-14 J. C. Martin Manzano vs G. Campana Lee selected=G. Campana Lee winner=? status=pending_no_result reason=no matching result rows found
...
- 2026-09-14 J. Wolf vs L. E. Ambrogi selected=J. Wolf winner=? status=pending_no_result reason=no matching result rows found
...
- 2026-09-14 Q. Vandecasteele vs B. N. Nakashima selected=Q. Vandecasteele winner=? status=pending_no_result reason=no matching result rows found
...
- 2026-09-16 Mikulskyte / Smith vs Strakhova / Tikhonova selected=Strakhova / Tikhonova winner=Strakhova V. / Tikhonova A. status=won basis=Challenger_results@2026-09-17:7-6 7-6
...
- 2026-09-17 Mikulskyte / Smith vs Strakhova / Tikhonova selected=Strakhova / Tikhonova winner=Strakhova V. / Tikhonova A. status=won basis=Challenger_results@2026-09-17:7-6 7-6
...
- 2026-09-18 A. Dougaz vs M. Shoaib selected=A. Dougaz winner=? status=pending_no_result reason=no matching result rows found
- 2026-09-18 A. Shevchenko vs M. Jones selected=M. Jones winner=? status=pending_no_result reason=no matching result rows found
- 2026-09-18 Andrea Lazaro Garcia vs Joelle Lilly Sophie Steur selected=Andrea Lazaro Garcia winner=? status=pending_no_result reason=result not final: live/in-progress markers present
- 2026-09-18 B. Artnak vs A. Vales selected=A. Vales winner=? status=pending_no_result reason=no matching result rows found
- 2026-09-18 F. Auger-Aliassime vs Q. Halys selected=F. Auger-Aliassime winner=? status=pending_no_result reason=no matching result rows found
...
- 2026-09-18 G. Trismuwantara vs C. Cretu selected=C. Cretu winner=? status=pending_no_result reason=no matching result rows found
- 2026-09-18 J. Lehecka vs B. Shelton selected=B. Shelton winner=? status=pending_no_result reason=no matching result rows found
- 2026-09-18 J. Mensik vs L. Tien selected=L. Tien winner=? status=pending_no_result reason=no matching result rows found
- 2026-09-18 M. Echargui vs M. Murtaza selected=M. Echargui winner=? status=pending_no_result reason=no matching result rows found
- 2026-09-18 M. Stoiana vs P. Badosa selected=P. Badosa winner=? status=pending_no_result reason=no matching result rows found

## By Tour

- `CHALLENGER`: settled=40, wins=19, hit_rate=0.475, ROI=-0.214054
- `WTA`: settled=9, wins=4, hit_rate=0.444444, ROI=-0.275714

## By Series

- `Challenger`: settled=40, wins=19, hit_rate=0.475, ROI=-0.214054
- `International`: settled=9, wins=4, hit_rate=0.444444, ROI=-0.275714

## By Surface

- `Hard`: settled=49, wins=23, hit_rate=0.469388, ROI=-0.223864

## By Bucket

- `SKIPPED_DEAD_EDGE`: settled=25, wins=15, hit_rate=0.6, ROI=-0.1428
- `SKIPPED_VETO`: settled=4, wins=2, hit_rate=0.5, ROI=-0.0175
- `WATCHLIST`: settled=15, wins=4, hit_rate=0.266667, ROI=-0.414
- `WATCHLIST_NO_ODDS`: settled=5, wins=2, hit_rate=0.4, ROI=None

## By Source

- `BetClan`: settled=8, wins=4, hit_rate=0.5, ROI=-0.155
- `BetClan, Forebet`: settled=1, wins=0, hit_rate=0.0, ROI=-1.0
- `Forebet`: settled=40, wins=19, hit_rate=0.475, ROI=-0.214054
