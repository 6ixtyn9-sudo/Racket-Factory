...
- ledger pick rows (in window): 82
- duplicate rows merged (same match + selection re-picked): 1
- stale history rows pruned (pick no longer in ledger): 50
- settled picks: 61
- wins: 31
- hit rate: 0.508197
- priced picks: 47
- ROI: -0.181915
- ROI (real-priced): -0.181915 (n=47)
- ROI (paper-priced): None (n=0)
- pending picks: 19
- void picks: 0
- conflict picks: 1
- total picks: 81
- set diagnostic picks: 61
- selected won any set: 46 (0.754098)
- selected won set 1: 32 (0.52459)
- selected won set 2: 35 (0.57377)
- selected won set 3: 10 (0.4)
...
- ledger rows in window (official): 82
- duplicate rows merged (same match + selection in multiple daily ledgers): 1
- stale history rows pruned (pick no longer in any archived ledger): 50
- audited rows: 81
...
- unresolved rows by reason:
  ...
  - pending_no_result: result not final: live/in-progress markers present: 9
...
- 2026-09-19 Alicia Herrero Linana vs Yasmine Kabbaj selected=Alicia Herrero Linana winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- 2026-09-19 Lisa Pigato vs Jeline Vandromme selected=Jeline Vandromme winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- `CHALLENGER`: total=56, settled=45, wins=23, hit_rate=0.511111, ROI=-0.177949, pending=11
- `WTA`: total=24, settled=15, wins=7, hit_rate=0.466667, ROI=-0.265714, pending=8, conflict=1

## By Series

- `ATP250`: total=1, settled=1, wins=1, hit_rate=1.0, ROI=0.25, pending=0
- `Challenger`: total=56, settled=45, wins=23, hit_rate=0.511111, ROI=-0.177949, pending=11
- `International`: total=24, settled=15, wins=7, hit_rate=0.466667, ROI=-0.265714, pending=8, conflict=1

## By Surface

- `Grass`: total=7, settled=4, wins=3, hit_rate=0.75, ROI=0.77, pending=3
- `Hard`: total=74, settled=57, wins=28, hit_rate=0.491228, ROI=-0.202609, pending=16, conflict=1

## By Bucket

- `SKIPPED_DEAD_EDGE`: total=41, settled=27, wins=17, hit_rate=0.62963, ROI=-0.094444, pending=13, conflict=1
- `SKIPPED_VETO`: total=9, settled=5, wins=3, hit_rate=0.6, ROI=0.042, pending=4
...
- `BetClan`: total=28, settled=18, wins=10, hit_rate=0.555556, ROI=-0.012857, pending=10
