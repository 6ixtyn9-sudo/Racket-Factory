...
- archived pick rows: 86
- archived pick dates: 8
- ledger pick rows (in window): 87
...
- ledger rows in window (official): 87
...
- unresolved rows by reason:
  ...
  - pending_no_result: result not final: live/in-progress markers present: 5
...
- 2026-09-20 Michael Mmoh vs J.J. Wolf selected=J.J. Wolf winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- 2026-09-20 Peyton Stearns vs Iva Jovic selected=Iva Jovic winner=? status=pending_no_result reason=result not final: live/in-progress markers present

## By Tour

- `ATP`: total=1, settled=1, wins=1, hit_rate=1.0, ROI=0.25, pending=0
- `CHALLENGER`: total=58, settled=48, wins=23, hit_rate=0.479167, ROI=-0.236667, pending=10
- `WTA`: total=27, settled=21, wins=10, hit_rate=0.47619, ROI=-0.253077, pending=5, conflict=1

## By Series

- `ATP250`: total=1, settled=1, wins=1, hit_rate=1.0, ROI=0.25, pending=0
- `Challenger`: total=58, settled=48, wins=23, hit_rate=0.479167, ROI=-0.236667, pending=10
- `International`: total=27, settled=21, wins=10, hit_rate=0.47619, ROI=-0.253077, pending=5, conflict=1

## By Surface

- `Grass`: total=9, settled=7, wins=3, hit_rate=0.428571, ROI=-0.5575, pending=2
- `Hard`: total=77, settled=63, wins=31, hit_rate=0.492063, ROI=-0.206731, pending=13, conflict=1

## By Bucket

- `SKIPPED_DEAD_EDGE`: total=44, settled=34, wins=20, hit_rate=0.588235, ROI=-0.146471, pending=9, conflict=1
...
- `WATCHLIST_NO_ODDS`: total=16, settled=14, wins=7, hit_rate=0.5, ROI=None, pending=2

## By Source

- `BetClan`: total=33, settled=27, wins=13, hit_rate=0.481481, ROI=-0.2825, pending=6
