...
- conflict picks: 0
- total picks: 27
- set diagnostic picks: 15
- selected won any set: 14 (0.933333)
- selected won set 1: 12 (0.8)
- selected won set 2: 11 (0.733333)
- selected won set 3: 2 (0.4)
...
- ledger rows in window (official): 27
...
- unresolved rows by reason:
  - pending_no_result: result not final: live/in-progress markers present: 11
...
- 2026-09-21 Katie Volynets vs Elvina Kalieva selected=Katie Volynets winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- 2026-09-21 Xinxin Yao vs Maya Joint selected=Maya Joint winner=? status=pending_no_result reason=result not final: live/in-progress markers present
...
- `CHALLENGER`: total=4, settled=4, wins=2, hit_rate=0.5, ROI=-1.0, pending=0
- `WTA`: total=23, settled=11, wins=9, hit_rate=0.818182, ROI=0.16, pending=12

## By Series

- `Challenger`: total=4, settled=4, wins=2, hit_rate=0.5, ROI=-1.0, pending=0
- `International`: total=23, settled=11, wins=9, hit_rate=0.818182, ROI=0.16, pending=12

## By Surface

- `Grass`: total=5, settled=4, wins=2, hit_rate=0.5, ROI=-1.0, pending=1
- `Hard`: total=22, settled=11, wins=9, hit_rate=0.818182, ROI=0.16, pending=11

## By Bucket

- `SKIPPED_DEAD_EDGE`: total=7, settled=5, wins=3, hit_rate=0.6, ROI=-0.212, pending=2
...
- `SKIPPED_VETO`: total=2, settled=0, wins=0, hit_rate=None, ROI=None, pending=2

## By Source

- `BetClan`: total=27, settled=15, wins=11, hit_rate=0.733333, ROI=-0.033333, pending=12

## By Regime

- `genesis-2026-09-20`: total=27, settled=15, wins=11, hit_rate=0.733333, ROI=-0.033333, pending=12
